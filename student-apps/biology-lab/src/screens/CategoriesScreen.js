  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <View><Text style={styles.headerTitle}>Biology Categories</Text><Text style={styles.headerSubtitle}>{stats.uniqueCompleted} of {stats.totalExperiments} experiments</Text></View>
      </View>
        ...
        <View style={styles.categoriesSection}>
          ...
          <View style={styles.categoriesGrid}>
            {categories.map((category) => {
              const categoryData = biologyExperiments[category.id];
...
const styles = StyleSheet.create({
  ...
  overallStatValue: { fontSize: 28, fontWeight: 'bold', color: '#2ecc71' },
  ...
  progressBar: { height: '100%', backgroundColor: '#2ecc71', borderRadius: 4 },
  ...
  completeBadge: { width: 20, height: 20, borderRadius: 10, backgroundColor: '#2ecc71', justifyContent: 'center', alignItems: 'center' },
